  ...
  return (
    ...
    className="max-w-200 mx-auto bg-white px-2">
        <div className="space-y-5">
            <div>
                <label className="block text-xl font-semibold text-gray-900">Animal Name</label>
            ...
            <div>
                <label className="block text-xl font-semibold text-gray-900">Breed</label>
                <input
                    name="breed"
            ...
            <div>
                <label className="block text-xl font-semibold text-gray-900">Profile Picture</label>
                <input
                    name="profilePicture"
